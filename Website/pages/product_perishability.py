...
# st.set_page_config(page_title="Product Perishability", layout="wide")
...
def product_perishability():
    try:
        ...
        estimated_avg_expiry_df = estimated_avg_expiry_df[estimated_avg_expiry_df["source"]=='Flipkart']
